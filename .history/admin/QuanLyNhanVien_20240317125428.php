        ...
        <table class="table table-bordered" id="myTable">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td><button class="btn btn-primary btn-sm" onclick="editData('. $row['idnv']. ')"><i class="fa fa-edit"></i></button> <button class="btn btn-danger btn-sm" onclick="deleteData('. $row['idnv']. ')"><i class="fa fa-trash"></i></button></td>';
                    echo '</tr>';
                }
                ?>
            </tbody>
