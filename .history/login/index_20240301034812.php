        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="https://png.pngtree.com/png-vector/20191030/ourlarge/pngtree-customer-service-representative-icon-vector-illustration-for-web-png-image_1927618.jpg" alt="IMG">
                </div>

                <form action="./loginControl.php" class="login100-form validate-form">
                    <span class="login100-form-title">
                        ĐĂNG NHẬP
                    </span>
                    
                        <div class="wrap-input100 validate-input" data-validate="Bạn cần nhập đúng thông tin như: abc.xyz">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Password không được bỏ trống!">
                            <input class="input100" type="password" placeholder="Mật Khẩu" name="current-password" id="password-field">
                        ...
                        <div class="container-login100-form-btn">
                            <input type="sumbit" value="Đăng Nhập" id="submit" onclick="validate()" />
                        </div>  
