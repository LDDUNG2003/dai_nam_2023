...
def insert_data_to_database(data):
    try:
        ...
        query = "INSERT INTO quanlynhanvien (ma_nv, dayCheckIn, TimeIN, TimeOut ) VALUES (%s, %s, %s, %s)"
...
if __name__ == "__main__":
    timeclock_address = "192.168.1.98"  # Địa chỉ IP của máy chấm công
